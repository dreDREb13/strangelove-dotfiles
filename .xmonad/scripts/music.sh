...
TCOL="#CDDEA6"         # The colour to be used to draw the song title when playing
ACOL="#A7BCBF"    # The colour to be used to draw the song artist when playing
PCOL="#DF7E7E"      # The colour to be used to draw both the song title and artist when paused
